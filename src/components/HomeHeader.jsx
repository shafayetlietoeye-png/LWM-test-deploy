        ...
        <>
            ...
            <header className="header">
                <div className="header__inner">
                    ...
                    {/* MOBILE TOP ROW */}
                    <div className="mbar">
                        <Link className="mbar__donate" to="/donate">Donate</Link>
                    ...
                    <span className="vline vline--left"></span>
                    <span className="vline vline--right"></span>
                    ...
                    {/* Center badge (Desktop / Mobile Closed) */}
                    <div className="center-badge">
                        <Link to="/"><img src="/assets/header logo.svg" alt="Museum Logo" /></Link>
                    </div>

                    {/* MOBILE CENTER TITLE (Mobile Closed) */}
                ...
                {/* Mobile Navigation Menu - Enhanced for Home Page */}
